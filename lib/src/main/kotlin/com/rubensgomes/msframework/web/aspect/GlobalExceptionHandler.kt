...
import com.rubensgomes.msframework.config.WebProperties
...
class GlobalExceptionHandler(
    ...
    private val methods: String =
        webProperties.allowedMethods
            .toString()
            .replace("[", "")
            .replace("]", "")

    // TODO ADD CLIENT_ID AND TRANSACTION_ID TO ERROR RESPONSES !!!
    ...
    fun handleMissingServletRequestPart(ex: MissingServletRequestPartException): ResponseEntity<ErrorResponse> {
    ...
    fun handleMissingMatrixVariable(ex: MissingMatrixVariableException): ResponseEntity<ErrorResponse> {
    ...
    fun handleUnsatisfiedRequestParameter(ex: UnsatisfiedRequestParameterException): ResponseEntity<ErrorResponse> {
    ...
    fun handleUnsupportedMediaTypeStatus(ex: UnsupportedMediaTypeStatusException): ResponseEntity<ErrorResponse> {
    ...
    fun handleUnsatisfiedServletRequestParameter(ex: UnsatisfiedServletRequestParameterException): ResponseEntity<ErrorResponse> {
    ...
    fun handleServletRequestBinding(ex: ServletRequestBindingException): ResponseEntity<ErrorResponse> {
    ...
    private fun logError(ex: Exception) {
        ...
        log.error(
            "handle exception error [$errorMsg] and native error [$errorNativeMsg]",
            ex,
        )
    }
}
